...
class hsr_SetBasePoseByTfNameState(EventState):
    '''
    ...
    def __init__(self, tf_name, service_name='/pose_server/getPose'):
        super(hsr_SetBasePoseByTfNameState,self).__init__(outcomes=['completed'],output_keys=['pose'])
