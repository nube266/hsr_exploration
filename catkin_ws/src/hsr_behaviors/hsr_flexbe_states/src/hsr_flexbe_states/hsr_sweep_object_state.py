...
class hsr_SweepObjectState(EventState):
    ...
    -- sweep_mode            String    How to sweep {'push':move back and forth, 'rotate': rotate}
    ...
    def on_enter(self, userdata):
        ...
        #
        req = sweep_serverRequest(self._target_name, self._sweep_place_type, self._waiting_time,
                                  self._sweep_mode, self._sweep_angular, self._sweep_distance, self._sweep_height)
        self._failed = False
        try:
