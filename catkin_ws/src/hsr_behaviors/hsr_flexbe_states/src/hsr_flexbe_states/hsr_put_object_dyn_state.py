...
class hsr_PutObjectDynState(EventState):
    '''
    ...
    def __init__(self, put_place_type, service_name='/grasp/put'):
        super(hsr_PutObjectDynState, self).__init__(input_keys=['target_name'], outcomes=['succeeded', 'failed'])
    ...
    def on_enter(self, userdata):
        ...
        rospy.loginfo('target_name : ' + self._target_name + '  put_place_type : ' + self._put_place_type)
        try:
