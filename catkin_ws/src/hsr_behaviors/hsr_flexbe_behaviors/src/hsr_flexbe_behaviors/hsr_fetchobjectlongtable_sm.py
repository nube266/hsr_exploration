...
'''
class HSRFetchObjectLongTableSM(Behavior):
	'''
...
Search -> Fetch -> Analyse
	...
	def __init__(self):
		super(HSRFetchObjectLongTableSM, self).__init__()
		self.name = 'HSR FetchObjectLongTable'
	...
	def create(self):
		...
		_state_machine.userdata.search_centroid_y_max = 0.6
		_state_machine.userdata.search_centroid_y_min = -0.6
		_state_machine.userdata.search_centroid_z_max = 0.6
		_state_machine.userdata.search_centroid_z_min = 0.42
